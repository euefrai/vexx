    ...
    >
      <div className="w-10 h-10 rounded-full bg-zinc-800 border border-green-500/30 overflow-hidden flex-shrink-0">
        {notification.from_user?.avatar_url ? (
          <img src={notification.from_user.avatar_url} alt="avatar" className="w-full h-full object-cover" />
        ) : (
          <div className="w-full h-full flex items-center justify-center text-xs">SQUAD</div>
        )}
      </div>
