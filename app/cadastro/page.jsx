...
import { validarCadastro, MENSAGENS_SUCESSO } from "@/utils/validators"
...
export default function Cadastro() {
  ...
  async function cadastrar(e) {
    ...
    // Validar inputs
    const validacao = validarCadastro(nome, email, senha, senhaConfirm)
    ...
    try {
      ...
      toast.success(MENSAGENS_SUCESSO.cadastroSucesso)
